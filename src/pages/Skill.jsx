...
import { SiPostgresql, SiNuxt } from "react-icons/si";
...
const Skill = () => {
  const skills = [
    ...
    { name: "Nuxt", icon: <SiNuxt />, color: "text-emerald-300" },
            ...
            >
              ...
              <div className="relative flex items-start justify-between gap-4">
                ...
                <div className="rounded-2xl border border-white/60 bg-white/70 p-4 shadow-lg shadow-slate-200/70 backdrop-blur-sm dark:border-slate-700/70 dark:bg-slate-900/70 dark:shadow-slate-950/30">
                  <div
                    className={`text-4xl transition duration-300 group-hover:scale-110 ${skill.color}`}
                  >
                    {skill.icon}
                  </div>
                </div>
